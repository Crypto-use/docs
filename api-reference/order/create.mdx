...
```bash
curl -X POST "https://api.cryptouse.com/api/order/create" \
...
```json Sucesso (201)
{
  ...
  "order": {
    ...
    "value": 100.00,
    "status": "PENDING",
    "qrCodeLink": "https://api.cryptouse.com/qr/binance/pmt_12345abcde.png",
...
5. Verifique o status da ordem usando o endpoint `GET /api/order/{id}`
